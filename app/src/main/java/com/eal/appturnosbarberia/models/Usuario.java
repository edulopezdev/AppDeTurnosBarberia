...
public class Usuario {
    ...
    public Usuario(int id, String nombre, String email, String telefono, String avatar, int rolId, String rolNombre, boolean accedeAlSistema, boolean activo, String passwordHash, String fechaRegistro, int idUsuarioCrea, Integer idUsuarioModifica, String fechaModificacion) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
